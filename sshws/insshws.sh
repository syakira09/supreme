...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/arismaramar/supreme/aio/sshws/ws-dropbear.service && chmod +x /etc/systemd/system/ws-dropbear.service
