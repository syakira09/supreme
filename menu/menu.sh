...
#EXPIRED
expired=$(curl -sS https://raw.githubusercontent.com/arismaramar/supreme/aio/permission/ip | grep $MYIP | awk '{print $3}')
...
do
	...
	if [[ $exp < $today ]]; then
        ...
        Exp2=$(curl -sS https://raw.githubusercontent.com/arismaramar/supreme/aio/permission/ip | grep $MYIP | awk '{print $3}')
	fi
